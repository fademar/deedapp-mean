...
export const immovablePropertyList = [
  "",
  "деревня",
  "поместье",
  "вотчина",
...
export const counterAgentActionsList = [
  "",
  "agrees to marry",
  "agrees to marry-off",
  "cedes",
